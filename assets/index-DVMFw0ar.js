 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rn;function yl(n){rn=n}const Fs=function(n){return typeof n=="number"?"number:"+fs(n):"string:"+n},Bs=function(n){if(n.isLeafNode()){const e=n.val();f(typeof e=="string"||typeof e=="number"||typeof e=="object"&&X(e,".sv"),"Priority must be a string or number.")}else f(n===rn||n.isEmpty(),"priority of unexpected type.");f(n===rn||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function At(n,e){return{eventCache:n,serverCache:e}}function Fe(n,e,t,i){return At(new re(e,t,i),n.serverCache)}function Gs(n,e,t,i){return At(n.eventCache,new re(e,t,i))}function vt(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function _e(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ic{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const Qs=new ic;class xn{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new re(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Pn(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:_e(this.viewCache_),r=tc(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let It;class Zs{constructor(){this.views=new Map}}function yc(n){f(!It,"__referenceConstructor has already been defined"),It=n}function vc(){return f(It,"Reference.ts has not been loaded"),It}function Cc(n){return n.views.size===0}function On(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return f(r!=null,"SyncTree gave us an op for an invalid query."),Fi(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(Fi(o,e,t,i));return r}}function er(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=Ct(t,s?i:null),l=!1;a?l=!0:i instanceof m?(a=kn(t,i),l=!1):(a=m.EMPTY_NODE,l=!1);const c=At(new re(a,l,!1),new re(i,s,!1));return new dc(e,c)}return o}function Ec(n,e,t,i,s,r){const o=er(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),mc(o,t),gc(o,t)}function wc(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=oe(n);if(s==="default")for(const[l,c]of n.views.entries())o=o.concat(Li(c,t,i)),Mi(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(s);l&&(o=o.concat(Li(l,t,i)),Mi(l)&&(n.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!oe(n)&&r.push(new(vc())(e._repo,e._path)),{removed:r,events:o}}function tr(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function ie(n,e){let t=null;for(const i of n.views.values())t=t||pc(i,e);return t}function nr(n,e){if(e._queryParams.loadsAllData())return kt(n);{const i=e._queryIdentifier;return n.views.get(i)}}function ir(n,e){return nr(n,e)!=null}function oe(n){return kt(n)!=null}function kt(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
